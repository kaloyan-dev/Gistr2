...
const UserProfile: FC = () => {
  ...
  const placeholder = 'relative before:absolute before:top-1/2 before:left-1/2 before:-translate-x-2/4 before:-translate-y-2/4 before:w-1/2 before:h-2/5 before:rounded-md';
