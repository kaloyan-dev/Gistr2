...
const Icon: FC<IconProps> = ({ type, classes, tooltip }) => {
    ...
    const getIcon = () => {
        switch (type) {
            ...
            case 'folder':
                return (
                    <svg fill="none" className={classes} viewBox="0 0 24 24" stroke="currentColor">
            ...
            case 'arrow-left':
                return (
                    <svg className={classes} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
